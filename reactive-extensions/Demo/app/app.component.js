...
System.register(['angular2/core', 'angular2/common', 'rxjs/add/operator/debounceTime', 'rxjs/add/operator/map', 'angular2/http', './github.service', './observablesExcercise.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, http_1, github_service_1, observablesExcercise_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (observablesExcercise_component_1_1) {
                observablesExcercise_component_1 = observablesExcercise_component_1_1;
            }],
        execute: function() {
            AppComponent = (function () {
                function AppComponent(fb, _gs) {
                    this._gs = _gs;
                ...
                AppComponent.prototype.ngOnInit = function () {
                    ...
                    this.search.valueChanges
                        ...
                        _this._gs.getUserAndFollowers(input).subscribe(function (res) {
                            _this.user = res.user;
                            _this.followers = res.followers;
                        }, function (err) {
                            console.log(err);
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [observablesExcercise_component_1.ObservablesExcerciseComponent]
                    }), 
                    __metadata('design:paramtypes', [common_1.FormBuilder, github_service_1.GithubService])
                ], AppComponent);
                return AppComponent;
            }());
